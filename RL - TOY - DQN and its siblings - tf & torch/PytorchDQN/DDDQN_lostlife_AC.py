...
class DQN_Dueling(nn.Module):
    def __init__(self, in_channels=12, num_action=4):
        ...
        self.conv2 = AugmentedConv(in_channels=32, out_channels=64, kernel_size=4, dk=16, dv=4, Nh=4,  stride=2)
        self.conv3 = AugmentedConv(in_channels=64, out_channels=64, kernel_size=3, dk=8, dv=4, Nh=4, stride=1)
...
num_episodes = 10000
experiment_dir = '../experiments/torch/DDDQN_LIFE_ATTENTION'
